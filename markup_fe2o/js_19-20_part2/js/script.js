...
// 1
var uniqSortedSkills = (_.uniq(_.sortBy(_.flatMap(data,'skills'))));
console.log('1. Unique alphabeticaly sorted array of skills:');
console.log(uniqSortedSkills);

// 2
var arrayOfNamesByFriends = (_.map(_.sortBy(data, 'friends'), 'name'));
console.log('2. Array of names sorted by friends quantity:');
console.log(arrayOfNamesByFriends);

// 3
var arrayOfAllFriends = ( _.union(_.map(_.flatMap(data, 'friends'), 'name')) );
console.log('3. Array of friend names:');
console.log(arrayOfAllFriends);
